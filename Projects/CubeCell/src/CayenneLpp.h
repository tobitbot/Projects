...
#define CUSTOM_TVOC 150             // 2 bytes, 0 -1187 ppb
#define CUSTOM_ECO2 151             // 2 bytes, 400 - 8192 ppm
...
#define CUSTOM_TVOC_SIZE 2
#define CUSTOM_ECO2_SIZE 2
...
#define CUSTOM_TVOC_MULT 1
#define CUSTOM_ECO2_MULT 1
...
public:
    ...
    uint8_t addTVOC(uint8_t channel, uint16_t value);
    uint8_t addEco2(uint8_t channel, uint16_t value);
